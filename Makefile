...
$(abspath $(SDK_ROOT)/components/libraries/util/nrf_log.c) \
...
$(abspath $(SDK_ROOT)/components/ble/ble_services/ble_nus_c/ble_nus_c.c) \
...
INC_PATHS += -I$(abspath $(SDK_ROOT)/components/ble/ble_db_discovery)
...
nrf52832_xxaa_s132: LINKER_SCRIPT=$(PROJ_HOME)/config/$(PROJECT_NAME)_gcc_nrf52.ld
